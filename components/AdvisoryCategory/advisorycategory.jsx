  ...
  return (
    <section className="text-[var(--rv-white)] overflow-hidden ">
      <div className="max-w-screen-xl main_section mx-auto flex flex-col lg:flex-row gap-4 items-start">
        ...
        <div className="w-full lg:w-1/2 bg-gradient-to-br from-[var(--rv-primary)] to-[var(--rv-bg-primary)] rounded-2xl  p-4 lg:p-10">
        ...
        >
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Mutual funds are one of the most trusted ways to grow your wealth over time.
            By pooling money from multiple investors, these funds strategically invest in a mix of
            stocks, bonds, and other securities — spreading risk while aiming for consistent returns.
            Whether you’re saving for retirement, your child’s education, or simply looking to build
            a long-term portfolio, mutual funds offer flexibility, professional management, and the
            potential for steady growth. Our experts carefully analyze performance, track market
            trends, and select funds that align with your financial goals and risk appetite, so you
